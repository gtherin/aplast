...
def get_expander():
    return st.expander(
        f"ℹ️ - {gl('About app')} (📧 [Guillaume](https://www.linkedin.com/in/guillaume-therin) [Martino](https://orcid.org/0000-0003-4414-1801) [Jules](https://orcid.org/0000-0001-6946-5015))",
        expanded=False,
    )
